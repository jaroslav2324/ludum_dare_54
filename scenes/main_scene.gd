...
func _on_interface_magic_tower_toggled(buttonPresed):
	if buttonPresed:
		get_node("game/icons/magicTowerArea/magicTowerIcon").visible = true
		get_node("game").magicTowerCanSpawn = true
	if !buttonPresed:
		get_node("game/icons/magicTowerArea/magicTowerIcon").visible = false
		get_node("game").magicTowerCanSpawn = false


func _on_interface_tower_toggled(buttonPresed):
	if buttonPresed:
		get_node("game/icons/realTowerArea/towerIcon").visible = true
		get_node("game").realTowerCanSpawn = true
	if !buttonPresed:
		get_node("game/icons/realTowerArea/towerIcon").visible = false
